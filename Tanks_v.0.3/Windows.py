...
class Windows():
    ...
    def __init__(self):
        ...
        self.rect_rect_GW = ((0, 0), (800, 768))  # расположение и размер

        self.rect_width_GW = 0#pygame.image.load(settings.WALLPAPER)
    ...
    def draw_windows(self, screen):
        ...
        pygame.draw.rect(screen, self.rect_color_GW, self.rect_rect_GW,
                        self.rect_width_GW)  # рисуем окно Game_Window
